---
layout: home
title: Fly Ash Bricks - Ascent Master Chem
description: Eco-friendly building blocks made from fly ash, cement, and water.
---

<!-- Hero Section -->
<div class="hero-section-detail">
  <div class="hero-image" style="background-image: url('https://images.unsplash.com/photo-1601058642989-77416ebfae62?w=800&auto=format&fit=crop')"></div>
  ...
  <div class="hero-content">
    <h1 class="hero-title">
      <span class="gradient-text">Fly Ash Bricks</span>
    </h1>
